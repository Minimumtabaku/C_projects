...
namespace pjc {
    ...
    pjc::list::const_iterator::const_iterator(node* ptr, const list* gen){
        current_ptr = ptr;
        o_list = gen;
    }
    ///const_ begin and such
    pjc::list::const_iterator list::begin() const{
        return list::const_iterator(head, this);
    }
    pjc::list::const_iterator list::end() const{
        return list::const_iterator(nullptr, this);
    }
    
    pjc::list::const_iterator list::cbegin() const{
        return list::const_iterator(head, this);
    }
    
    pjc::list::const_iterator list::cend() const{
       return list::const_iterator(nullptr, this);
    }
    ///const_iterator operators
    pjc::list::const_iterator& list::const_iterator::operator++(){ //prefix
    ...
    pjc::list::const_iterator& list::const_iterator::operator--(){
    ...
    pjc::list::const_iterator list::const_iterator::operator++(int num){
    ...
    pjc::list::const_iterator::reference list::const_iterator::operator*() const{
        return current_ptr->val;
        
    }
    pjc::list::const_iterator::pointer list::const_iterator::operator->() const{
        return &current_ptr->val;
    }
    bool pjc::list::const_iterator::operator==(const list::const_iterator& rhs)const{
    ...
    ///dynamic iterator
    pjc::list::iterator::iterator(node* ptr, const list* gen){
        current_ptr = ptr;
        o_list = gen;
    }
    pjc::list::iterator list::begin(){
        list::iterator iterator = list::iterator(head, this);
        return iterator;
    }
    pjc::list::iterator list::end(){
        list::iterator iterator = list::iterator(nullptr, this);
        return iterator;
    }
    bool pjc::list::iterator::operator==(const list::iterator& rhs)const{
        return current_ptr == rhs.current_ptr && o_list == rhs.o_list;
    }
    bool pjc::list::iterator::operator!=(const list::iterator& rhs)const{
        return current_ptr != rhs.current_ptr || o_list != rhs.o_list;
    }
    pjc::list::iterator& list::iterator::operator++(){ //prefix
        if (current_ptr != nullptr) {
            current_ptr = current_ptr->next;
        }else{
            current_ptr = nullptr;
    ...
    pjc::list::iterator list::iterator::operator++(int){ // postfix
        list::iterator iterator = list::iterator(current_ptr, o_list);
        current_ptr = current_ptr->next;
        return iterator;
        
    }
    pjc::list::iterator list::iterator::operator--(int){
        list::iterator iterator = list::iterator(current_ptr, o_list);
        if(current_ptr != nullptr){
            current_ptr = current_ptr->prev;
        } else {
    ...
    pjc::list::iterator::operator const_iterator() const {
        return list::const_iterator(current_ptr, o_list);
    }
    pjc::list::iterator::reference list::iterator::operator*() const{
        return current_ptr->val;
    }
    pjc::list::iterator::pointer list::iterator::operator->() const{
        return &current_ptr->val;
    }
    /// LIST THINGIES
    pjc::list::list(const list& rhs){
        for (auto element : rhs ) {
            push_back(element);
        }
    }
    pjc::list& list::operator=(const list& rhs){
    ...
    pjc::list& list::operator=(list&& rhs){
        while(num_elements != 0){
            pop_back();
        }
    ...
    pjc::list::list(const std::vector<double>& vec){
    ...
    void pjc::list::push_back(double elem){
    ...
    double const& pjc::list::back() const{
    ...
    void pjc::list::push_front(double elem){
        node* newNode = new node;
        newNode->val = elem;
